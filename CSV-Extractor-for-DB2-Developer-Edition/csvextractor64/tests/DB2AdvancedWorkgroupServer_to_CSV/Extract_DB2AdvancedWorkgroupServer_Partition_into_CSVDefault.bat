...
::Description:	Extract DB2AdvancedWorkgroupServer table into CSVDefault location.
::Arguments:
...
echo y|c:\Python27\csvextractor_dist_64\20141201_211447\csvextractor64\csvextractor64.exe ^
-w dbtaws2csv ^
-o 1 ^
-r 1 ^
-t "|" ^
