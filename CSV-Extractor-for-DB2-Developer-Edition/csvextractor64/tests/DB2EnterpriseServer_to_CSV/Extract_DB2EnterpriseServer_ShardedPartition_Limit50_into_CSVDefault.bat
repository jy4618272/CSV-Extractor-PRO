...
::Description:	Extract only 50 rows from DB2EnterpriseServer table into CSVDefault location.
::Arguments:
...
echo y|c:\Python27\csvextractor_dist_64\20141201_212131\csvextractor64\csvextractor64.exe ^
-w dbtes2csv ^
-o 3 ^
-r 3 ^
-t "|" ^
