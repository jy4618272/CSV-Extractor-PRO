...
----------------------------------------------------------------------
CSV*Extractor for MariaDB (v1.23.9, beta, 2014/12/04 16:21:28) [32bit]
...
1. CSV_to_MariaDB. 4 use cases.



CSV_to_MariaDB: 4 use case(s) available:

1. CSV_FileSkip1_to_MARIA - Skip 1 rows and load CSV file into MariaDB  table.
2. CSV_DirSkip1_to_MARIA - Read each CSV file from a directory "C:\Python27\data_migrator_1239\test\v101\data\mysql_data_dir".
  Skip 1 rows and load CSV file into MariaDB  table.
3. CSV_File_to_MARIA - Load CSV file into MariaDB  table.
4. CSV_Dir_to_MARIA - Read each CSV file from a directory "C:\Python27\data_migrator_1239\test\v101\data\mysql_data_dir".
