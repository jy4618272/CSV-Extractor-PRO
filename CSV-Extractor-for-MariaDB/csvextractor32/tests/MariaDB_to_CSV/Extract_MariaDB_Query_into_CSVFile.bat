::Test name: MariaDB_Query
::Description:	Extract MariaDB table into CSVFile location.
::Arguments:
...
echo y|c:\Python27\csvextractor_dist_32\20141201_215302\csvextractor32\csvextractor32.exe ^
-w maria2csv ^
-o 1 ^
-r 1 ^
-t "|" ^
...
-g c:\Python27\data_migrator_1239\CSV_OUT\testMARIA_Query.data