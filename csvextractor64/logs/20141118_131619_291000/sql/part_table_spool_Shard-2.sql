...
SELECT PERSONID ||'|'||
 ...
 FIRSTNAME2 ||'|'||
 ADDRESS2 ||'|'||
 TO_CHAR(CREATEDT,'YYYY-MM-DD HH24.MI.SS.FF2')||'' FROM (SELECT * FROM SCOTT.Persons_partitioned PARTITION(sales_apr2014) WHERE ROWID BETWEEN 'AAASN1AAEAAAAL4AAA' AND 'AAASN1AAEAAAAL/ABk' )   ;
exit;
