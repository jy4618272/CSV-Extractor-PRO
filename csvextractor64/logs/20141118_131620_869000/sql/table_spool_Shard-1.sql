...
SELECT PERSONID ||'|'||
 ...
 FIRSTNAME2 ||'|'||
 ADDRESS2 ||'|'||
 TO_CHAR(CREATEDT,'YYYY-MM-DD HH24.MI.SS.FF2')||'' FROM (SELECT * FROM SCOTT.Persons_sub_partitioned WHERE ROWID BETWEEN 'AAASWmAAEAAAAOQAAA' AND 'AAASWmAAEAAAAOXABk' )   ;
exit;
