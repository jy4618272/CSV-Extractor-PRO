::Test name: TimesTen_ShardedQuery
::Description:	Extract TimesTen table into CSVDefault location.
::Arguments:
...
echo y|c:\Python27\csvextractor_dist_64\20141204_083818\csvextractor64\csvextractor64.exe ^
-w tten2csv ^
-o 3 ^
-r 3 ^
-t "|" ^
